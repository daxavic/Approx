...
public class Base<E> {
    ...
    public Base<E> subList(int fromElement, Boolean fromInclusive, int toElement, Boolean toInclusive) {return new Base<>();}
    //возвращает новый List, который состоит из элементов, находящихся между fromElement и toElement
